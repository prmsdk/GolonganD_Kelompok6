...
<div class="mySlides fadeSlide img-fluid">
    ...
    <img src="src/img/slider/print-1.jpg">
    <div class="banner-absolute1 text-light text-center font-m-semi">
    <h1>Mau Cetak Brosur? Kalender? Kartu Nama? <br>tidak perlu ribet! Pesan disini Sekarang!</h1>
    <a class="btn btn-primary btn-lg mt-2" href="#" role="button">Pesan</a>
    </div>
</div>
...
<div class="mySlides fadeSlide img-fluid">
    ...
    <a class="btn btn-primary btn-lg mt-2" href="#" role="button">Daftar Produk</a>
    </div>
</div>
