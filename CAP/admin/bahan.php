...
<html lang="en">
  <head>
    ...
    <title>FORM UKURAN</title>
  </head>
  <body>
    <div class="container">
        <h2 class="alert alert-primary text-center mt-3">FORM BAHAN</h2>
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <form action="add_master.php" method="POST">
                    <div class="form-group">
                        <label>Jenis Bahan</label>
                        <input type="text" name="" class="form-control" placeholder="Masukkan Nama Jenis bahan">
                    </div>
